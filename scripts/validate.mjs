...
import { runWorkspaceAccessTests } from './workspace-access.test.mjs';
...
const requiredFiles = ['index.html', 'styles.css', 'views.css', 'state.css', 'trace.css', 'scenario.css', 'interaction.css', 'status.css', 'status-state.css', 'queue.css', 'guide.css', 'guide.js', 'export.js', 'hash-nav.js', 'date-window.css', 'date-window.js', 'assumptions.css', 'assumptions.js', 'activity.css', 'activity-review.css', 'activity-approval.css', 'activity-reset.css', 'activity-export.css', 'activity.js', 'supplier-detail.css', 'supplier-detail.js', 'po-detail.css', 'po-detail.js', 'po-milestones.css', 'material-detail.css', 'material-detail.js', 'fixture-import.css', 'fixture-import.js', 'ownership.css', 'ownership.js', 'saved-views.css', 'saved-views.js', 'comments.css', 'comments.js', 'resolution.css', 'resolution-queue.css', 'resolution.js', 'table-filter.css', 'table-filter.js', 'table-sort.css', 'table-sort.js', 'triage.css', 'triage.js', 'scenario-compare.css', 'scenario-compare.js', 'share-view.css', 'share-view.js', 'offline.css', 'responsive-fix.css', 'supabase-auth.css', 'supabase-auth.js', 'pwa.js', 'sw.js', 'app.js', 'server.mjs', 'db/001_workspace_snapshots.sql', 'db/002_workspace_access.sql', 'db/postgres-store.mjs', 'db/workspace-access-store.mjs', 'db/pool.mjs', 'db/validate-snapshot.mjs', 'scripts/api.test.mjs', 'scripts/api-connection.test.mjs', 'scripts/postgres-store.test.mjs', 'scripts/workspace-access.test.mjs', 'scripts/snapshot-validation.test.mjs', 'scripts/migrate-database.mjs', 'scripts/grant-workspace-member.mjs', 'scripts/seed-database.mjs', 'scripts/import-snapshot.mjs', 'scripts/export-snapshot.mjs', 'scripts/validate-snapshot-file.mjs', 'data/fixture.json', 'package-lock.json', '.env.example', 'favicon.svg', 'site.webmanifest', 'robots.txt'];
